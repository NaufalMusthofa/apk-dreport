        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="ai-icon" href="/teknisi/dashboard" aria-expanded="false">
							<i class="flaticon-025-dashboard"></i>
							<span class="nav-text">Dashboard</span>
						</a>
                    </li>
                    <li><a class="ai-icon" href="/teknisi/tugas" aria-expanded="false">
                    ...
                    {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="chart-flot.html">Laporan 1</a></li>
                            <li><a href="chart-morris.html">Laporan 2</a></li>
                            <li><a href="chart-chartjs.html">Laporan 3</a></li>
                        </ul>
                    </li> --}}

                </ul>
				<div class="copyright">
					<p><strong>Get Management Teknisi Dashboard</strong> © 2024 All Rights Reserved</p>
				</div>
			</div>
        </div>
        <!--**********************************
