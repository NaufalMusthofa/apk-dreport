...
<head>
	...
	<meta property="og:title" content="Get : Payment Admin Template">
	<meta property="og:description" content="Dompet : Payment Admin Template">
	<meta property="og:image" content="https://dompet.dexignlab.com/xhtml/social-image.png">
	<meta name="format-detection" content="telephone=no">
	
	<!-- PAGE TITLE HERE -->
	<title href="{{ asset('templates/images/title_bar/logo-get.png')}}" width="90" height="80">Get : Daily Report Activity</title>
	
	<!-- FAVICONS ICON -->
	{{-- <link rel="shortcut icon" type="image/png" href="{{ asset('templates/images/title_bar/logo-get.png') }}"> --}}
	
	<link href="{{ asset('templates/vendor/jquery-nice-select/css/nice-select.css') }}" rel="stylesheet">
...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
				<img src="{{ asset('templates/images/title_bar/logo-get.png') }}" width="90" height="80" alt="">
                <h4 class="brand-title">Get</h4>
            </a>
				...
				<ul class="metismenu" id="menu">
					<li class="dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<img src="{{ asset('templates/images/profile/boy1.png') }}" width="20" alt="">
						...
						<div class="dropdown-menu dropdown-menu-end">
							...
							<a href="page-error-404.html" class="dropdown-item ai-icon" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    ...
                    <li><a class="ai-icon" href="/admin/dashboard" onclick="location.reload();" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/admin/lokasi">Lokasi</a></li>
							<li><a href="/admin/keperluan">Keperluan</a></li>
                            <li><a href="/admin/pekerjaan" aria-expanded="false">Pekerjaan</a>
                            </li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<img src="{{ asset('templates/images/sidebar_admin/report.png') }}" width="25" height="25" alt="">
							<span class="nav-text ms-3">Laporan</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="chart-flot.html">Laporan Per Teknisi</a></li>
                            <li><a href="chart-morris.html">Laporan Per Lokasi</a></li>
                            <li><a href="chart-chartjs.html">Laporan Per Pekerjaan</a></li>
                        </ul>
                    </li>
                    <li><a class="ai-icon" href="/admin/tugas" aria-expanded="false">
							<img src="{{ asset('templates/images/sidebar_admin/task.png') }}" width="25" height="25" alt="">
							<span class="nav-text ms-3">Tugas</span>
						</a>
                    </li>
                    <li><a class="ai-icon" href="/admin/user-management/user" aria-expanded="false">
							<img src="{{ asset('templates/images/sidebar_admin/management.png') }}" width="25" height="25" alt="">
							<span class="nav-text ms-3">User Management</span>
						</a>
                    </li>

                </ul>
				<div class="copyright">
					<p><strong>Get Management Admin Dashboard</strong> © 2024 All Rights Reserved</p>
					<p class="fs-12">Made with <span class="heart"></span> by Muhammad Naufal Musthofa</p>
				</div>
			</div>
        </div>
        <!--**********************************
    ...
    ***********************************-->
	...
	<script src="{{ asset('templates/vendor/nouislider/nouislider.min.js') }}"></script>
	<script src="{{ asset('templates/vendor/wnumb/wNumb.js') }}"></script>
