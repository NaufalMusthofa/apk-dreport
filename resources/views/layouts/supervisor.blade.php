...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Get : Daily Report Activity</title>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="ai-icon" href="/supervisor/dashboard" onclick="location.reload();" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/supervisor/lokasi">Lokasi</a></li>
							<li><a href="/supervisor/keperluan">Keperluan</a></li>
                            <li><a href="/supervisor/pekerjaan" aria-expanded="false">Pekerjaan</a>
                            </li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
				...
				<div class="copyright">
					<p><strong>Get Management Supervisor Dashboard</strong> © 2024 All Rights Reserved</p>
				</div>
			</div>
        </div>
        <!--**********************************
